...
TELEGRAM_BOT_TOKEN = '7497693355:AAFMsLS_UR4ytCH9afgF1lDvFtDLMVtHvN4'
ADMIN_USER_ID = 5901320388
...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        "*🔥 𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝗧𝗼 彡[𝙅𝙊𝙆𝙍 𝙑𝙄𝙋 𝘿𝘿𝙊𝙎 ❤️‍🔥♡Ｆᵉə𝑑ᗷǻc𝑘 ♡❤️‍🔥]彡 𝗗𝗱𝗼𝘀*\n"
        "*🔥 𝗢𝘄𝗻𝗲𝗿 @bgmi_fuck_server*\n"
        "*🔥 SERVER BGMI*\n"    
...
async def manage(update: Update, context: CallbackContext):
    ...
    if chat_id != 5901320388:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ 𝗬𝗼𝘂 𝗡𝗲𝗲𝗱 𝗧𝗼 𝗚𝗲𝘁 𝗣𝗲𝗿𝗺𝗶𝘀𝘀𝗼𝗻 𝗙𝗼𝗿 𝗨𝘀𝗲 𝗧𝗵𝗶𝘀 𝗖𝗼𝗺𝗺𝗮𝗻𝗱 𝗗𝗠 » @bgmi_fuck_server*", parse_mode='Markdown')
        return
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in users:
        await context.bot.send_message(chat_id=chat_id, text="*🤡 𝐘𝐨𝐮 𝐍𝐞𝐞𝐝 𝐓𝐨 𝐆𝐞𝐭 𝐏𝐞𝐫𝐦𝐢𝐬𝐬𝐨𝐧 𝐓𝐨 𝐔𝐬𝐞 𝐓𝐡𝐢𝐬 𝐁𝐨𝐭 » @bgmi_fuck_server*", parse_mode='Markdown')
        return
